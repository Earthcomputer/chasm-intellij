...
public class ChasmParser implements PsiParser, LightPsiParser {
  ...
  public static boolean additiveExpression(PsiBuilder b, int l) {
    ...
    r = r && additiveExpression_2(b, l + 1);
    r = r && additivePrecedence(b, l + 1);
  ...
  public static boolean bitwiseAndExpression(PsiBuilder b, int l) {
    ...
    r = r && bitwiseAndExpression_2(b, l + 1);
    r = r && bitwiseAndPrecedence(b, l + 1);
    exit_section_(b, l, m, r, false, null);
    return r;
  }
  ...
  public static boolean bitwiseOrExpression(PsiBuilder b, int l) {
    ...
    r = r && bitwiseOrExpression_2(b, l + 1);
    r = r && bitwiseOrPrecedence(b, l + 1);
    exit_section_(b, l, m, r, false, null);
    return r;
  }
  ...
  public static boolean bitwiseXorExpression(PsiBuilder b, int l) {
    ...
    r = r && bitwiseXorExpression_2(b, l + 1);
    r = r && bitwiseXorPrecedence(b, l + 1);
    exit_section_(b, l, m, r, false, null);
    return r;
  }
  ...
  public static boolean booleanAndExpression(PsiBuilder b, int l) {
    ...
    r = r && booleanAndExpression_2(b, l + 1);
    r = r && booleanAndPrecedence(b, l + 1);
    exit_section_(b, l, m, r, false, null);
    return r;
  }
  ...
  public static boolean booleanOrExpression(PsiBuilder b, int l) {
    ...
    r = r && booleanOrExpression_2(b, l + 1);
    r = r && booleanOrPrecedence(b, l + 1);
    exit_section_(b, l, m, r, false, null);
    return r;
  }
  ...
  /* ********************************************************** */
  // SKIP? LPAREN SKIP? expression SKIP? RPAREN
  public static boolean callExpression(PsiBuilder b, int l) {
    ...
    r = r && callExpression_2(b, l + 1);
    r = r && expression(b, l + 1);
    r = r && callExpression_4(b, l + 1);
  ...
  public static boolean equalityExpression(PsiBuilder b, int l) {
    ...
    r = r && equalityExpression_2(b, l + 1);
    r = r && equalityPrecedence(b, l + 1);
    exit_section_(b, l, m, r, false, null);
    return r;
  }
  ...
  /* ********************************************************** */
  // SKIP? LBRACKET SKIP? expression SKIP? RBRACKET
  public static boolean indexExpression(PsiBuilder b, int l) {
    ...
    r = r && indexExpression_2(b, l + 1);
    r = r && expression(b, l + 1);
    r = r && indexExpression_4(b, l + 1);
  ...
  /* ********************************************************** */
  // LBRACKET SKIP? (expression (SKIP? COMMA SKIP? expression)* SKIP? (COMMA SKIP?)?)? RBRACKET
  ...
  // (expression (SKIP? COMMA SKIP? expression)* SKIP? (COMMA SKIP?)?)?
  ...
  /* ********************************************************** */
  // NULL | BOOL | FLOAT | INTEGER | STRING | CHAR
  ...
  public static boolean multiplicativeExpression(PsiBuilder b, int l) {
    ...
    r = r && multiplicativeExpression_2(b, l + 1);
    r = r && multiplicativePrecedence(b, l + 1);
    exit_section_(b, l, m, r, false, null);
    return r;
  }
  ...
  /* ********************************************************** */
  // LPAREN SKIP? expression SKIP? RPAREN
  public static boolean parenthesesExpression(PsiBuilder b, int l) {
    ...
    r = r && parenthesesExpression_1(b, l + 1);
    r = r && expression(b, l + 1);
    r = r && parenthesesExpression_3(b, l + 1);
    r = r && consumeToken(b, RPAREN);
    exit_section_(b, m, PARENTHESES_EXPRESSION, r);
    return r;
  }
  ...
  public static boolean relationalExpression(PsiBuilder b, int l) {
    ...
    r = r && relationalExpression_2(b, l + 1);
    r = r && relationalPrecedence(b, l + 1);
    exit_section_(b, l, m, r, false, null);
    return r;
  }
  ...
  public static boolean shiftExpression(PsiBuilder b, int l) {
    ...
    r = r && shiftExpression_2(b, l + 1);
    r = r && shiftPrecedence(b, l + 1);
    exit_section_(b, l, m, r, false, null);
    return r;
  }
  ...
  public static boolean ternaryExpression(PsiBuilder b, int l) {
    ...
    r = r && ternaryExpression_3(b, l + 1);
    r = r && ternaryPrecedence(b, l + 1);
    r = r && ternaryExpression_5(b, l + 1);
    r = r && consumeToken(b, COLON);
    r = r && ternaryExpression_7(b, l + 1);
    r = r && ternaryPrecedence(b, l + 1);
    exit_section_(b, l, m, r, false, null);
    return r;
  }
