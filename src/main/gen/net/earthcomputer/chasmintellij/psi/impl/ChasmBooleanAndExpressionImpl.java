...
public class ChasmBooleanAndExpressionImpl extends ChasmExpressionImpl implements ChasmBooleanAndExpression {

  public ChasmBooleanAndExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ChasmVisitor visitor) {
    visitor.visitBooleanAndExpression(this);
  }
