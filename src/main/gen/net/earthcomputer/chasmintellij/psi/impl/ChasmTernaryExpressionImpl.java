...
public class ChasmTernaryExpressionImpl extends ChasmExpressionImpl implements ChasmTernaryExpression {

  public ChasmTernaryExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public ChasmExpression getCondition() {
  ...
  @Override
  @Nullable
  public ChasmExpression getTrueExpr() {
    List<ChasmExpression> p1 = getExpressionList();
  ...
  @Override
  @Nullable
  public ChasmExpression getFalseExpr() {
    List<ChasmExpression> p1 = getExpressionList();
