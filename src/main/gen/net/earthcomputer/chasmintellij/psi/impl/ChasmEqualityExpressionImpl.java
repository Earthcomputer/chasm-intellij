...
public class ChasmEqualityExpressionImpl extends ChasmExpressionImpl implements ChasmEqualityExpression {

  public ChasmEqualityExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
