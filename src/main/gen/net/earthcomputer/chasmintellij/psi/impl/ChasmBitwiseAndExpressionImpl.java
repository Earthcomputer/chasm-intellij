...
public class ChasmBitwiseAndExpressionImpl extends ChasmExpressionImpl implements ChasmBitwiseAndExpression {

  public ChasmBitwiseAndExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
