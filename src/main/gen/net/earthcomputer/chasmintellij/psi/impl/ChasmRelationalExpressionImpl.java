...
public class ChasmRelationalExpressionImpl extends ChasmExpressionImpl implements ChasmRelationalExpression {

  public ChasmRelationalExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
