...
public class ChasmBooleanOrExpressionImpl extends ChasmExpressionImpl implements ChasmBooleanOrExpression {

  public ChasmBooleanOrExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ChasmVisitor visitor) {
    visitor.visitBooleanOrExpression(this);
  }
