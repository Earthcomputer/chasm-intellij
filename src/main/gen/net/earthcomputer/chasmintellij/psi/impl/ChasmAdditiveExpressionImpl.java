...
public class ChasmAdditiveExpressionImpl extends ChasmExpressionImpl implements ChasmAdditiveExpression {

  public ChasmAdditiveExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
