...
public class ChasmIndexExpressionImpl extends ChasmExpressionImpl implements ChasmIndexExpression {

  public ChasmIndexExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public ChasmExpression getOwner() {
  ...
  @Override
  @Nullable
  public ChasmExpression getIndex() {
    List<ChasmExpression> p1 = getExpressionList();
