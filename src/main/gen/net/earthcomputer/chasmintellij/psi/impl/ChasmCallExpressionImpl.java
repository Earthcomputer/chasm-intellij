...
public class ChasmCallExpressionImpl extends ChasmExpressionImpl implements ChasmCallExpression {

  public ChasmCallExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public ChasmExpression getFunction() {
  ...
  @Override
  @Nullable
  public ChasmExpression getArgument() {
    List<ChasmExpression> p1 = getExpressionList();
