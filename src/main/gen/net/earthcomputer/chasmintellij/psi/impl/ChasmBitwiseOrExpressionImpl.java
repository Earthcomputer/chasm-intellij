...
public class ChasmBitwiseOrExpressionImpl extends ChasmExpressionImpl implements ChasmBitwiseOrExpression {

  public ChasmBitwiseOrExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
